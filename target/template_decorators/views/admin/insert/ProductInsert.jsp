...
<div class="wrap-form-center">
    <section class="formCenter shadow p-3 mb-5 bg-body rounded">
        ...
        <div>
            ...
            <form method="post" class="card-body" action="<c:url value='/admin/product'/>" id="wtfloihoai">
                <div class="row gy-3">
                    <div class="col-12">
                        <h6 class="form-label fw-bold">Product name <i class="fa fa-laptop"></i>
                        </h6>
                        <input maxlength="200" name="productName" class="form-control" value="${model.productName}"
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input maxlength="20" required name="price" class="form-control" value="${model.price}"
                ...
                <div class="row gy-3">
                    <div class="col-md-3">
                        ...
                        <input maxlength="20" required name="sCpu" class="form-control" value="${model.sCpu}"
                               placeholder="Enter your sCpu ..." required>
                    </div>
                    <div class="col-md-9">
                        <h6 class="form-label fw-bold">Detail CPU: </h6>
                        <input  maxlength="150" required name="cpu" class="form-control" value="${model.cpu}"
                ...
                <div class="row gy-3">
                    <div class="col-md-3">
                        ...
                        <input  maxlength="20" required name="sVga" class="form-control" value="${model.sVga}"
                               placeholder="Enter your sVga ...">
                    </div>
                    <div class="col-md-9">
                        <h6 class="form-label fw-bold">Detail VGA:</h6>
                        <input  maxlength="150" required name="vga" class="form-control" value="${model.vga}"
                ...
                <div class="row gy-3">
                    <div class="col-md-3">
                        ...
                        <input  maxlength="20" required name="sRam" class="form-control" value="${model.sRam}"
                               placeholder="Enter your sRam ...">
                    </div>
                    <div class="col-md-9">
                        <h6 class="form-label fw-bold">Detail RAM:</h6>
                        <input   maxlength="150"  required name="ram" class="form-control" value="${model.ram}"
                ...
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input  maxlength="150"  required name="storage" class="form-control" value="${model.storage}"
                ...
                <div class="row gy-3">
                    <div class="col-md-6">
                        ...
                        <input  maxlength="20" required name="sSsd" class="form-control" value="${model.sSsd}"
                               placeholder="Enter your sSsd ...">
                    </div>
                    <div class="col-md-6">
                        <h6 class="form-label fw-bold">Hdd</h6>
                        <input  maxlength="20" required name="sHdd" class="form-control" value="${model.sHdd}"
                ...
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input  maxlength="150"  required name="monitor" class="form-control" value="${model.monitor}"
                ...
                <div class="row gy-3">
                    <div class="col-md-4">
                        ...
                        <input  maxlength="20" required name="sSize" class="form-control" value="${model.sSize}"
                               placeholder="Enter your sSize ...">
                    </div>
                    <div class="col-md-4">
                        <h6 class="form-label fw-bold">Hz</h6>
                        <input  maxlength="20" required name="sHz" class="form-control" value="${model.sHz}"
                               placeholder="Enter your sHz ...">
                    </div>
                    <div class="col-md-4">
                        <h6 class="form-label fw-bold">Resolution</h6>
                        <input   maxlength="20" required name="sResolution" class="form-control"  value="${model.sResolution}"
                ...
                <div class="row gy-3">
                    <div class="col-md-6">
                        ...
                        <input  maxlength="20" required name="sWeight" class="form-control" value="${model.sWeight}"
                               placeholder="Enter your sWeight ...">
                    </div>
                    <div class="col-md-6">
                        <h6 class="form-label fw-bold">Color <i class="fa fa-eye-dropper"></i></h6>
                        <input   maxlength="150"  required name="color" class="form-control" value="${model.color}"
                ...
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input  maxlength="150"  required name="pin" class="form-control" value="${model.pin}"
                ...
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input  maxlength="150" required name="connection" class="form-control" value="${model.connection}"
