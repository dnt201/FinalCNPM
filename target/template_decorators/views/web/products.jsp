        ...
        <div class="product-list">
            <div class="list-header">
                ...
                <div class="header-sort-list">
                    ...
                    <select onchange="onChangeSelect(this)" id="select_sort">
                        <option value="1">
                            Tên (A - Z)
                        </option>
                        <option value="-1">
                    ...
                    <input hidden id="sort_select" value="1"/>
                </div>
            </div>
...
<script>
    function onChangeSelect(obj) {
        document.getElementById("sort_select").value = obj.value
        console.log(window.location.hostname);
        window.location.href = window.location.hostname+"/products?sortSelect="+obj.value+"&brand_id="+
